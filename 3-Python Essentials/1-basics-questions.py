...
list_1 = [1, 2, 3, 4, 5, 6]
# Question: How deo you use the gt_thre function to filter elements greater than 3 from list_1?
...
class DataExtractor:
    def __init__ (self, some_value):
        self.some_value = some_value
    def print_some_value(self):
        print(self.some_value)

object = DataExtractor(10)
object.print_some_value()
